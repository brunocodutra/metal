...
/// [iota]
IS_SAME(
  metal::v8::sort<metal::numbers<7, -4, 2>, metal::lambda<metal::less>>,
  metal::numbers<-4, 2, 7>
);

IS_SAME(
  metal::v8::sort<metal::numbers<7, -4, 2>>,
  metal::numbers<-4, 2, 7>
);

static_assert(!metal::is_invocable<metal::lambda<metal::v8::sort>, void, metal::lambda<metal::less>>{}, "");
/// [iota]
)
