...
#ifndef BOOST_MPL2_ALGORITHM_DETAIL_LINK_HPP
#define BOOST_MPL2_ALGORITHM_DETAIL_LINK_HPP

#include <boost/mpl2/algebra/arithmetic/inc.hpp>
#include <boost/mpl2/algorithm/size.hpp>
#include <boost/mpl2/algorithm/detail/ref.hpp>
