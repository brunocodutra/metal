...
BOOST_MPL2_ASSERT((std::is_same<apply<test::wrapper, short, int, long, long long>::type, test::wrapper>));
BOOST_MPL2_ASSERT((std::is_same<apply<protect<test::wrapper>, void>::type, test::wrap<void>>));
...
BOOST_MPL2_ASSERT((std::is_same<apply<lambda<_1>, void>::type, lambda<void>>));
BOOST_MPL2_ASSERT((std::is_same<apply<protect<lambda<_1>>, void>::type, void>));

BOOST_MPL2_ASSERT((std::is_same<apply<lambda<_1>, protect<_1>>::type, lambda<protect<_1>>>));
BOOST_MPL2_ASSERT((std::is_same<apply<protect<_1>, lambda<_1>>::type, lambda<_1>>));

BOOST_MPL2_ASSERT((std::is_same<apply<quoter<protect>, _1>::type, quoter<protect>>));
BOOST_MPL2_ASSERT((std::is_same<apply<protect<quoter<protect>>, _1>::type, protect<_1>>));
