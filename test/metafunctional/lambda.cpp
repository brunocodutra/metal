...
BOOST_MPL2_ASSERT((std::is_same<invoke<bind<lambda<std::add_pointer<_1> >, _0>, void>::type, void*>));
BOOST_MPL2_ASSERT((std::is_same<invoke<lambda<bind<lambda<std::add_pointer<_1> >, _0> >, void>::type, void*>));
