...
struct oneary
{
    template<typename> using call = c;
};

template<typename c>
struct nullary
{
    template<typename = void> using call = c;
};
...
BOOST_MPL2_ASSERT((not_<is_evaluable<oneary<test::fundamental> > >));
BOOST_MPL2_ASSERT((not_<is_evaluable<oneary<test::function> > >));
...
BOOST_MPL2_ASSERT((not_<is_evaluable<nullary<test::fundamental> > >));
BOOST_MPL2_ASSERT((not_<is_evaluable<nullary<test::function> > >));
...
BOOST_MPL2_ASSERT((is_function<oneary<test::fundamental> >));
BOOST_MPL2_ASSERT((is_function<oneary<test::function> >));
...
BOOST_MPL2_ASSERT((is_function<nullary<test::fundamental> >));
BOOST_MPL2_ASSERT((is_function<nullary<test::function> >));
...
BOOST_MPL2_ASSERT((not_<is_callable<oneary<test::fundamental> > >));
BOOST_MPL2_ASSERT((not_<is_callable<oneary<test::function> > >));
...
BOOST_MPL2_ASSERT((not_<is_callable<nullary<test::fundamental> > >));
BOOST_MPL2_ASSERT((not_<is_callable<nullary<test::function> > >));
...
BOOST_MPL2_ASSERT((not_<is_applicable<oneary<test::fundamental> > >));
BOOST_MPL2_ASSERT((not_<is_applicable<oneary<test::function> > >));
...
BOOST_MPL2_ASSERT((not_<is_applicable<nullary<test::fundamental> > >));
BOOST_MPL2_ASSERT((not_<is_applicable<nullary<test::function> > >));
