...
BOOST_MPL2_ASSERT((not_<is_evaluable<test::unary<test::eponym>::call>>));
...
BOOST_MPL2_ASSERT((not_<is_evaluable<test::unary<test::eponym>::call, void>>));
...
BOOST_MPL2_ASSERT((not_<is_evaluable<test::unary<test::eponym>::call, void, void*>>));
...
BOOST_MPL2_ASSERT((not_<is_evaluable<test::binary<test::eponym>::call>>));
...
BOOST_MPL2_ASSERT((not_<is_evaluable<test::binary<test::eponym>::call, void>>));
...
BOOST_MPL2_ASSERT((not_<is_evaluable<test::binary<test::eponym>::call, void, void*>>));
...
BOOST_MPL2_ASSERT((not_<is_evaluable<test::n_ary<test::eponym>::call>>));
...
BOOST_MPL2_ASSERT((not_<is_evaluable<test::n_ary<test::eponym>::call, void>>));
...
BOOST_MPL2_ASSERT((not_<is_evaluable<test::n_ary<test::eponym>::call, void, void*>>));
