...
static_assert(or_<std::false_type, std::false_type, std::false_type, std::true_type>::value, "");
static_assert(or_<std::false_type, std::false_type, std::false_type, std::false_type, std::true_type>::value, "");
static_assert(or_<std::false_type, std::false_type, std::false_type, std::false_type, std::false_type, std::true_type>::value, "");
...
static_assert(and_<std::true_type, std::true_type, std::true_type, std::true_type>::value, "");
static_assert(and_<std::true_type, std::true_type, std::true_type, std::true_type, std::true_type>::value, "");
static_assert(and_<std::true_type, std::true_type, std::true_type, std::true_type, std::true_type, std::true_type>::value, "");
...
static_assert(or_<std::true_type, undefined, undefined, undefined>::value, "");
static_assert(or_<std::true_type, undefined, undefined, undefined, undefined>::value, "");
static_assert(or_<std::true_type, undefined, undefined, undefined, undefined, undefined>::value, "");
