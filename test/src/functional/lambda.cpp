...
BOOST_METAL_ASSERT((std::is_same<call_t<lambda<_0>, short, int, long, long long>, _0>));
...
BOOST_METAL_ASSERT((std::is_same<call_t<lambda<call<protect<_0>>>, test::wrapper, void>, call<_0>>));
