...
using bound = bind<evaluator<std::add_pointer>, placeholders::_1>;
...
BOOST_METAL_ASSERT((std::is_same<call_t<bind<evaluator<std::add_pointer>, bound>, void>, void**>));
BOOST_METAL_ASSERT((std::is_same<call_t<bind<evaluator<std::add_pointer>, protect<bound>>, void>, bound*>));
BOOST_METAL_ASSERT((std::is_same<call_t<bind<evaluator<std::add_pointer>, protect<protect<bound>>>, void>, protect<bound>*>));
