...
static_assert(is_evaluable_t<test::strict>::value, "");
...
static_assert(is_evaluable_t<test::strict, test::a0>::value, "");
...
static_assert(is_evaluable_t<test::strict, test::a0, test::a1>::value, "");
