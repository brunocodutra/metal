...
static_assert(not_<is_same_expression_t<test::e0, test::en>>::value, "");
static_assert(not_<is_same_expression_t<test::e1, test::e0>>::value, "");
static_assert(not_<is_same_expression_t<test::e2, test::e1>>::value, "");
static_assert(not_<is_same_expression_t<test::en, test::e2>>::value, "");
