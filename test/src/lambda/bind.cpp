...
using lbd4 = test::seq<_1, _2, _3, _4>;
...
METAL_TEST_ASSERT((std::is_same<apply_t<bind_t<lbd4, quote_t<_4>, _3, _2, _1>, test::v0, test::v1, test::v2, test::v3>, test::seq<_4, test::v2, test::v1, test::v0>>::value));
