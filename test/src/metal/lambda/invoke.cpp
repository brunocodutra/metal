...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<VAL(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<NUM(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<PAIR(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<VECT(M) COMMA(N) VALS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<VECT(M) COMMA(N) NUMS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<VECT(M) COMMA(N) PAIRS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<VECT(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<VECT(M) COMMA(N) LISTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<VECT(M) COMMA(N) MAPS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<VECT(M) COMMA(N) LBDS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<MAP(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<LBD(M) COMMA(N) VECTS(N)>), (BOOL(M == N))); \
    ...
    ASSERT((metal::is_invocable<LBD(_) COMMA(N) VECTS(N)>), (TRUE)); \
