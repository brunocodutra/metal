...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, VAL(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, NUM(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, PAIR(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, VECT(M) COMMA(N) VALS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, VECT(M) COMMA(N) NUMS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, VECT(M) COMMA(N) PAIRS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, VECT(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, VECT(M) COMMA(N) LISTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, VECT(M) COMMA(N) MAPS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, VECT(M) COMMA(N) LBDS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, LIST(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, MAP(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, LBD(M) COMMA(N) VECTS(N)>), (TRUE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::partial>, LBD(_) COMMA(N) VECTS(N)>), (TRUE)); \
