...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::accumulate_t<VEC(M), metal::list<>, metal::push_front<metal::_1, metal::_2>, NUM(M), NUM(0)>), (metal::accumulate_t<VEC(M), metal::list<>, metal::push_back<metal::_1, metal::_2>>)); \
