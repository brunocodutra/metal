...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::any>, VAL(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::any>, NUM(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::any>, PAIR(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::any>, VECT(M), VAL(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::any>, VECT(M), NUM(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::any>, VECT(M), PAIR(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::any>, VECT(M), VECT(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::any>, VECT(M), LIST(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::any>, VECT(M), MAP(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::any>, VECT(M), LBD(N)>), (BOOL(N == 1))); \
    ASSERT((metal::is_invocable<test::lambda<metal::any>, VECT(M), LBD(_)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::any>, LIST(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::any>, MAP(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::any>, LBD(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::any>, LBD(_), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::any<VECT(M), test::lambda<metal::is_number>>), (FALSE)); \
    ...
    ASSERT((metal::any<VECT(M), test::lambda<metal::is_pair>>), (FALSE)); \
    ...
    ASSERT((metal::any<VECT(M), test::lambda<metal::is_lambda>>), (FALSE)); \
