...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::copy_if<metal::list<ENUM(M, FWD, NUM, PAIR, LBD)>, test::lambda<metal::is_number>>), (metal::list<NUMS(M)>)); \
    ASSERT((metal::copy_if<metal::list<ENUM(M, FWD, NUM, PAIR, LBD)>, test::lambda<metal::is_pair>>), (metal::list<PAIRS(M)>)); \
    ASSERT((metal::copy_if<metal::list<ENUM(M, FWD, NUM, PAIR, LBD)>, test::lambda<metal::is_lambda>>), (metal::list<LBDS(M)>)); \
/**/
