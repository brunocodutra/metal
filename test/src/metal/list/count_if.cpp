...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::count_if<metal::list<ENUM(M, FWD, NUM, PAIR, LBD)>, test::lambda<metal::is_number>>), (PTRDIFF_T(M))); \
    ASSERT((metal::count_if<metal::list<ENUM(M, FWD, NUM, PAIR, LBD)>, test::lambda<metal::is_pair>>), (PTRDIFF_T(M))); \
    ASSERT((metal::count_if<metal::list<ENUM(M, FWD, NUM, PAIR, LBD)>, test::lambda<metal::is_lambda>>), (PTRDIFF_T(M))); \
/**/
