...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::none>, VAL(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::none>, NUM(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::none>, PAIR(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::none>, VECT(M), VAL(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::none>, VECT(M), NUM(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::none>, VECT(M), PAIR(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::none>, VECT(M), VECT(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::none>, VECT(M), LIST(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::none>, VECT(M), MAP(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::none>, VECT(M), LBD(N)>), (BOOL(N == 1))); \
    ASSERT((metal::is_invocable<test::lambda<metal::none>, VECT(M), LBD(_)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::none>, LIST(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::none>, MAP(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::none>, LBD(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::none>, LBD(_), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::none<VECT(M), test::lambda<metal::is_number>>), (TRUE)); \
    ...
    ASSERT((metal::none<VECT(M), test::lambda<metal::is_pair>>), (TRUE)); \
    ...
    ASSERT((metal::none<VECT(M), test::lambda<metal::is_lambda>>), (TRUE)); \
