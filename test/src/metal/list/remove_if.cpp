...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, VAL(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, NUM(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, PAIR(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, PAIR(M), LBD(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, PAIR(M), LBD(_)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, VECT(M), VAL(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, VECT(M), NUM(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, VECT(M), PAIR(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, VECT(M), VECT(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, VECT(M), LIST(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, VECT(M), MAP(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, VECT(M), LBD(N)>), (BOOL(N == 1))); \
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, VECT(M), LBD(_)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, LIST(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, MAP(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, MAP(M), LBD(N)>), (BOOL(!M))); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, LBD(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::remove_if>, LBD(_), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::remove_if<VECT(M), test::lambda<metal::is_number>>), (VECT(M))); \
    ASSERT((metal::remove_if<PAIR(M), test::lambda<metal::is_pair>>), (PAIR(M))); \
    ASSERT((metal::remove_if<VECT(M), test::lambda<metal::is_pair>>), (VECT(M))); \
    ASSERT((metal::remove_if<PAIR(M), test::lambda<metal::is_lambda>>), (PAIR(M))); \
    ASSERT((metal::remove_if<VECT(M), test::lambda<metal::is_lambda>>), (VECT(M))); \
    ASSERT((metal::remove_if<test::list<ENUM(M, FWD, NUM, PAIR, LBD)>, test::lambda<metal::is_number>>), (test::list<ENUM(M, FWD, PAIR, LBD)>)); \
    ASSERT((metal::remove_if<test::list<ENUM(M, FWD, NUM, PAIR, LBD)>, test::lambda<metal::is_pair>>), (test::list<ENUM(M, FWD, NUM, LBD)>)); \
    ASSERT((metal::remove_if<test::list<ENUM(M, FWD, NUM, PAIR, LBD)>, test::lambda<metal::is_lambda>>), (test::list<ENUM(M, FWD, NUM, PAIR)>)); \
/**/
