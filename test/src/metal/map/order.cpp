...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::order>, VAL(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::order>, NUM(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::order>, PAIR(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::order>, VECT(M), VAL(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::order>, VECT(M), NUM(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::order>, VECT(M), PAIR(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::order>, VECT(M), VECT(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::order>, VECT(M), LIST(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::order>, VECT(M), MAP(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::order>, VECT(M), LBD(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::order>, VECT(M), LBD(_)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::order>, LIST(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::order>, MAP(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::order>, LBD(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::order>, LBD(_), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::order<test::list<PAIRS(N) COMMA(N) test::list<NUM(N), LBD(N)>>, NUM(N)>), (metal::size_t<N>)); \
/**/
