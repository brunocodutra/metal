...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::add>, VAL(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::add>, NUM(M) COMMA(N) VECTS(N)>), (BOOL(!N))); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::add>, PAIR(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::add>, VECT(M) COMMA(N) VALS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::add>, VECT(M) COMMA(N) NUMS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::add>, VECT(M) COMMA(N) PAIRS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::add>, VECT(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::add>, VECT(M) COMMA(N) LISTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::add>, VECT(M) COMMA(N) MAPS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::add>, VECT(M) COMMA(N) LBDS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::add>, LIST(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::add>, MAP(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::add>, LBD(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::add>, LBD(_) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::add<NUM(M) COMMA(N) NUMS(N)>), (NUMBER(N*(N - 1)/2 + M, test::value_type<NUM(M) COMMA(N) ENUM(N, NUM) COMMA(N) IF(NOT(N))( , NUMBER(0, int))>))); \
/**/
