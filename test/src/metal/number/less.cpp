...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::less>, VAL(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::less>, NUM(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::less>, PAIR(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::less>, VECT(M), VAL(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::less>, VECT(M), NUM(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::less>, VECT(M), PAIR(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::less>, VECT(M), VECT(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::less>, VECT(M), LIST(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::less>, VECT(M), MAP(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::less>, VECT(M), LBD(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::less>, VECT(M), LBD(_)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::less>, LIST(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::less>, MAP(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::less>, LBD(M), VECT(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::less>, LBD(_), VECT(N)>), (FALSE)); \
