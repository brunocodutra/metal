...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, VAL(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, NUM(M) COMMA(N) VECTS(N)>), (BOOL(!N))); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, PAIR(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, VECT(M) COMMA(N) VALS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, VECT(M) COMMA(N) NUMS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, VECT(M) COMMA(N) PAIRS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, VECT(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, VECT(M) COMMA(N) LISTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, VECT(M) COMMA(N) MAPS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, VECT(M) COMMA(N) LBDS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, LIST(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, MAP(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, LBD(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::or_>, LBD(_) COMMA(N) VECTS(N)>), (FALSE)); \
