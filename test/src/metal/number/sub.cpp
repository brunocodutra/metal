...
#define MATRIX(M, N) \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, VAL(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, NUM(M) COMMA(N) VECTS(N)>), (BOOL(!N))); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, PAIR(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, VECT(M) COMMA(N) VALS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, VECT(M) COMMA(N) NUMS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, VECT(M) COMMA(N) PAIRS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, VECT(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, VECT(M) COMMA(N) LISTS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, VECT(M) COMMA(N) MAPS(N)>), (FALSE)); \
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, VECT(M) COMMA(N) LBDS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, LIST(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, MAP(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, LBD(M) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::is_invocable<test::lambda<metal::sub>, LBD(_) COMMA(N) VECTS(N)>), (FALSE)); \
    ...
    ASSERT((metal::sub<NUM(M) COMMA(N) NUMS(N)>), (NUMBER(N*(1 - N)/2 + M, test::value_type<NUM(M) COMMA(N) ENUM(N, NUM) COMMA(N) IF(NOT(N))( , NUMBER(0, int))>))); \
/**/
