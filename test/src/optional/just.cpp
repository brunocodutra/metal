...
METAL_TEST_ASSERT((!std::is_same<just<test::v0>::type, test::v9>::value));
METAL_TEST_ASSERT((!std::is_same<just<test::v1>::type, test::v0>::value));
METAL_TEST_ASSERT((!std::is_same<just<test::v2>::type, test::v1>::value));
METAL_TEST_ASSERT((!std::is_same<just<test::v3>::type, test::v2>::value));
METAL_TEST_ASSERT((!std::is_same<just<test::v4>::type, test::v3>::value));
METAL_TEST_ASSERT((!std::is_same<just<test::v5>::type, test::v4>::value));
METAL_TEST_ASSERT((!std::is_same<just<test::v6>::type, test::v5>::value));
METAL_TEST_ASSERT((!std::is_same<just<test::v7>::type, test::v6>::value));
METAL_TEST_ASSERT((!std::is_same<just<test::v8>::type, test::v7>::value));
METAL_TEST_ASSERT((!std::is_same<just<test::v9>::type, test::v8>::value));
